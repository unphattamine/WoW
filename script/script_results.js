window.onload = function() {
    ...
    document.getElementById("PMTotal1").innerText = localStorage.getItem("PMTotal1") + " hours";
    ...
    document.getElementById("TBATotal1").innerText = localStorage.getItem("TBATotal") + " hours";
    ...
    document.getElementById("SATotal1").innerText = localStorage.getItem("SATotal") + " hours";
