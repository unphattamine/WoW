...
function calculatePrice() {
    function calculatePrice1(channelsCoefficient){
        console.log("UCs <=6")
        //TIMELINE FORMULAS
        ...
        //recalculated again due to channelCoefficient
        totalTimeline = (config.elapsedTimeKickoff + solutionTimeline + devTimeline + UATTimeline + HypercareTimeline)*channelsCoefficient;
        ...
        if (TotalHoursEnablement === 0) {
            ...
            TotalAmount = TotalSell*channelsCoefficient;
            ...
            TotalAmount = TotalSellEnablement*channelsCoefficient;
            TotalAmountBMS1 = TotalAmount/2;
            TotalAmountBMS2 = TotalAmount/2;
        }
    ...
    function calculatePrice2(channelsCoefficient){
        ...
        //recalculated again due to channelCoefficient
        totalTimeline = (config.elapsedTimeKickoff + solutionTimeline*0.75 + devTimeline + UATTimeline + HypercareTimeline)*channelsCoefficient;
        let TotalCostEnablement;
        let TotalCostEnablementwContingency;
        let TotalSellEnablement;
        let TotalAmountBMS1;
    ...
    function calculatePrice3(channelsCoefficient){
        console.log("UCs >> 12");
        //ALERT
        function manyUCs() {
            Swal.fire({
        ...
        //recalculated again due to channelCoefficient
        totalTimeline = (config.elapsedTimeKickoff + solutionTimeline*0.5 + devTimeline + UATTimeline + HypercareTimeline)*channelsCoefficient;
        let TotalCostEnablement;
        let TotalCostEnablementwContingency;
        let TotalSellEnablement;
        let TotalAmountBMS1;
    ...
    //CHANNELS COUNT AND COEFFICIENT
...
console.log(channelsCoefficient); // This will print the coefficient value
    ...
    calculatePrice1(channelsCoefficient);
    } else if((complexUCs+simpleUCs>6)&&(complexUCs+simpleUCs)<=12){
    calculatePrice2(channelsCoefficient);
    } else {
    calculatePrice3(channelsCoefficient);
    }
}
